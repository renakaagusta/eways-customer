...
class UpdateCustomer: ViewModel() {
    private val services = CustomerApiServices::class.java
    private val result = MutableLiveData<CustomerSingleResponse>()

    fun set(id: String, username: String, fullname: String, phoneNumber: String, email: String, password: String, address: String, addressLat: Float, addressLng: Float) {
        MyRetrofit
            .createService(services)
            .updateCustomer(id, username, fullname, phoneNumber, email, password, address, addressLat, addressLng)
