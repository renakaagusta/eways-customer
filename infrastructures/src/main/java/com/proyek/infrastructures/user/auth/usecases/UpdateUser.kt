...
class UpdateUser: ViewModel() {
    ...
    internal fun set(id: String, username: String, fullname: String, phoneNumber: String, email: String, password: String, imagePath: String, role: Int, activeStatus: Boolean, verifStatus: Boolean) {
        MyRetrofit
            .createService(services)
            .updateUser(id, username, fullname, phoneNumber, email, password, imagePath, role, activeStatus, verifStatus)
